...
function Consent_PageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Consent_PageComponents)
...
function pre_questionairreRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of pre_questionairreComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function pre_questionare2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of pre_questionare2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function first_loopLoopBegin(first_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisFirst_loop of first_loop) {
...
function first_textRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of first_textComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function first_AI_judgmentRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of first_AI_judgmentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function first_checkRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of first_checkComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trust_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trust_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function second_AI_judgmentRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of second_AI_judgmentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function second_AI_judgment_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of second_AI_judgment_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function second_checkRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of second_checkComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
